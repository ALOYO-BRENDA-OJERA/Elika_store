          ...
          <Card>
            ...
            <CardContent>
              {!isLoggedIn ? (
                ...
                <p className="text-sm text-destructive">
                  {(ordersQuery.error as any)?.message || 'Failed to load orders'}
                </p>
                    ...
                    <TableBody>
                      {filteredOrders.map((o) => (
                        <TableRow key={o.id}>
                          ...
                          <TableCell>
                            <Badge className={`${statusColors[o.status]} border-0 capitalize`}>
                              {o.status}
                            </Badge>
                          </TableCell>
                          ...
                          <TableCell>
                            <Button variant="outline" size="sm" onClick={() => openDetails(o.orderNumber)}>
                              View
                            </Button>
                          </TableCell>
                        </TableRow>
